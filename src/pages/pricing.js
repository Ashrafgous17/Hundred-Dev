                    ...
                    >
                      <div className="pricing-card">
                        <div className="pricing-top">
                          ...
                          <div className="right">
                            <img
                              src="assets/img/home-3/pricing-vec1.svg"
                              alt=""
                            />
                          </div>
                        </div>
                      ...
                      <div className="pricing-card two">
                        <div className="pricing-top">
                          <div className="left">
                            ...
                            <h2>
                              <sup>$</sup>44<sub>/Month</sub>
                            </h2>
                          </div>
                          <div className="right">
                            <div className="offer-tag">
                              <img
                                src="assets/img/home-3/price-bg.svg"
                                alt=""
                              />
                              <h5>
                                30% <br />
                    ...
                    >
                      <div className="pricing-card">
                        <div className="pricing-top">
                          ...
                          <div className="right">
                            <img
                              src="assets/img/home-3/pricing-vec2.svg"
                              alt=""
                            />
                          </div>
                        </div>
