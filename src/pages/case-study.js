                  ...
                  <div className="col-lg-12 col-md-6 border-bottom1">
                    <div className="home6-case-study">
                      <div className="case-img magnetic-item">
                        <img
                          className="img-fluid"
                          src="assets/img/home-6/home6-case-01.png"
                          alt=""
                        />
                        &gt;
                      </div>
                      <div className="case-content pb-50">
                        ...
                        <h3>
                          <Link legacyBehavior href="/project-details">
                            <a>
                              Unlocking Scalability, Reliability, and
                              Efficiency.
                            </a>
                          </Link>
                        </h3>
                        <p>
                          ...
                          ullamcorper necbomi doloroei. aptent taciti sociosqu.
                        </p>
                    ...
                    <div className="home6-case-study">
                      <div className="magnetic-wrap">
                        <div className="case-img pt-50 magnetic-item">
                          <img
                            className="img-fluid"
                            src="assets/img/home-6/home6-case-02.png"
                            alt=""
                          />
                        </div>
                      </div>
                      <div className="case-content">
                        ...
                        <h3>
                          <Link legacyBehavior href="/project-details">
                            <a>
                              Empowering Businesses through Cutting-Edge Mobile.
                            </a>
                          </Link>
                        </h3>
                        <p>
                    ...
                    <div className="home6-case-study pb-50">
                      <div className="magnetic-wrap">
                        <div className="case-img magnetic-item">
                          <img
                            className="img-fluid"
                            src="assets/img/home-6/home6-case-03.png"
                            alt=""
                          />
                        </div>
                      </div>
                      <div className="case-content">
                        ...
                        <h3>
                          <Link legacyBehavior href="/case-study-details">
                            <a>Empowering Business Performan through Expert.</a>
                          </Link>
                        </h3>
                        <p>
                          Integer purus odio, placerat nec rhoncus in,
                    ...
                    <div className="home6-case-study">
                      <div className="magnetic-wrap">
                        <div className="case-img pt-50 magnetic-item">
                          <img
                            className="img-fluid"
                            src="assets/img/home-6/home6-case-04.png"
                            alt=""
                          />
                        </div>
                      </div>
